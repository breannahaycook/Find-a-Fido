    ...
    <main>
        <div class="sidenav">
            ...
            <form action="../controllers/breed_info_controller.php" method="post">
                ...
                <br><br>
                Training Level:<br>
                <input type="radio" id="low" name="training_level" value="Low">
                <label for="low">Low</label><br>
                <input type="radio" id="moderate" name="training_level" value="Moderate">
                <label for="moderate">Moderate</label><br>
                <input type="radio" id="high" name="training_level" value="High">
                <label for="high">High</label>
                
                <br><br>
                Activity Level:<br>
                <input type="radio" id="sedentary" name="activity_level" value="Sedentary">
                <label for="sedentary">Sedentary</label><br>
                <input type="radio" id="moderately_active" name="activity_level" value="Moderately Active">
                <label for="moderately_active">Moderately Active</label><br>
                <input type="radio" id="very_active" name="activity_level" value="Very Active">
                <label for="very_active">Very Active</label>
                
                <br><br>
                Grooming Needs:<br>
                <input type="radio" id="minimal" name="grooming" value="Minimal">
                <label for="minimal">Minimal</label><br>
                <input type="radio" id="moderate" name="grooming" value="Moderate">
                <label for="moderate">Moderate</label><br>
                <input type="radio" id="a_lot" name="grooming" value="A Lot">
                <label for="a_lot">A Lot</label>
                
                <br><br>
                Shedding Level:<br>
                <input type="radio" id="minimal" name="shedding" value="Minimal">
                <label for="minimal">Minimal</label><br>
                <input type="radio" id="moderate" name="shedding" value="Moderate">
                <label for="moderate">Moderate</label><br>
                <input type="radio" id="a_lot" name="shedding" value="A Lot">
                <label for="a_lot">A Lot</label>
                
                <br><br>
                Hypoallergenic:<br>
                <input type="radio" id="yes" name="hypoallergenic" value="Yes">
                <label for="yes">Yes</label><br>
                <input type="radio" id="no" name="hypoallergenic" value="No">
                <label for="no">No</label>
                
                <br><br>
                Kids Temperament:<br>
                <input type="radio" id="poor" name="kids_temp" value="Poor">
                <label for="poor">Poor</label><br>
                <input type="radio" id="good" name="kids_temp" value="Good">
                <label for="good">Good</label><br>
                <input type="radio" id="great" name="kids_temp" value="Great">
                <label for="great">Great</label>

                <br><br>
                Noise Level:<br>
                <input type="radio" id="quiet" name="noise_level" value="Quiet">
                <label for="quiet">Quiet</label><br>
                <input type="radio" id="medium" name="noise_level" value="Medium">
                <label for="medium">Medium</label><br>
                <input type="radio" id="very_vocal" name="noise_level" value="Very Vocal">
                <label for="very_vocal">Very Vocal</label>

                <br><br>
                Household Size Needed:<br>
                <input type="radio" id="very_little" name="household_size" value="Very Little">
                <label for="very_little">Very Little</label><br>
                <input type="radio" id="a_little" name="household_size" value="A Little">
                <label for="a_little">A Little</label><br>
                <input type="radio" id="a_lot" name="household_size" value="A Lot">
                <label for="a_lot">A Lot</label>
            ...
            foreach($breeds as $breed_info) : ?>
                <div class="container">
                    <section>
                        ...
                        <table>
                            <tr>
                                <td><img class="results" src="../utility/assets/<?php echo $breed_name; ?>.jpg" alt="Picture of a <?php echo $breed_name; ?>"></td>
                                <td>
                                    <h4>Size:</h4> 
                        ...
                        <p><?php echo $breed_info-> get_information(); ?></p>
                        <h4><?php $breed_info-> get_id(); ?></h4>
                    </section>
                </div>
            <?php endforeach; 
        } else {
